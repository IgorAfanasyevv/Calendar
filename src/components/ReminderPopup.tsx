...
export default function ReminderPopup({ workspaceId }: { workspaceId: string }) {
  ...
  return (
    <div className="fixed z-40 bottom-24 md:bottom-6 left-4 md:left-6 w-[calc(100%-2rem)] max-w-sm rounded-2xl bg-white dark:bg-neutral-900 shadow-2xl border border-neutral-200/60 dark:border-neutral-800 p-4 animate-[modalIn_.2s_ease-out]">

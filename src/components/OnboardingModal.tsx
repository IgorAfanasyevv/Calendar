...
const SLIDES: Slide[] = [
  ...
  {
    icon: Flame,
    title: 'Привычки и важные даты',
    text: 'Привычки — личные или общие, со стриками (сколько дней подряд не пропускали). В "Датах" — дни рождения и годовщины, чтобы никогда не забыть.',

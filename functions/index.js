...
На каждый день — завтрак, обед, ужин и один перекус. Простые, реалистичные для готовки дома блюда, но по-настоящему вкусные и разнообразные — это критически важно, разнообразие проверяется по всем 7 дням сразу:
- Ни одно блюдо не должно повторяться в течение недели, включая перекусы
- Меняй основной источник белка от приёма к приёму (курица, рыба, говядина, индейка, яйца, бобовые/тофу, творог, морепродукты) — не бери один и тот же белок больше 2 раз за все 7 дней
- Меняй гарнир/углеводную основу (рис, гречка, картофель, макароны, киноа, булгур, батат) — не повторяй один и тот же гарнир больше 2 раз за неделю

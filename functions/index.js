...
тебя самого, не для показа пользователю, поэтому не расписывай его развёрнуто):
Перед итоговым JSON распиши расчёт для каждого блюда ОДНОЙ строкой в формате
"Название: инг1 Xг×Yккал/100г=Zккал(БжУ); инг2 ...; ИТОГО: N ккал (Б.. Ж.. У..)" — без лишних слов, только сами числа.
Пройдись так по каждому блюду из обоих наборов, затем сразу переходи к JSON.
